...
Una Lealtad puede tener bajo su órbita otras Lealtades menores, ya sea como afiliadas, aliadas o subyugadas.

Además de las grandes potencias, existen **imperios menores**, **ligas**, **alianzas regionales** y **estados clientes**, entre otros muchos reconocidos como formas válidas de Lealtad.

Toda Lealtad legítima controla al menos **dos mundos y una ruta de salto** entre ellos, lo que le otorga entidad territorial y capacidad operativa.

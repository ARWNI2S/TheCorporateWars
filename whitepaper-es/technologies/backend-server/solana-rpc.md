...
La función de esta capa de servicios, por tanto, no es reimplementar la lógica on-chain, sino orquestar su acceso desde los nodos de simulación, respetando las reglas de consistencia, periodicidad y eficiencia de red.

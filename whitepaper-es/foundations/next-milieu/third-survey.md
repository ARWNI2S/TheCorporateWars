...
Antaño cuna de aventureros, hoy el Servicio de Exploración es una institución más burocrática. Tras dar por completo el Segundo Censo Estelar, se dedico a fortalecer y modernizar las rutas de Correo Imperial, delegando gran parte de su actividad de campo al sector privado.

### Editcto Imperial 1143.1

En el año 1143 el Primer Edicto Imperial fue la aprobacion y entrada en vigor de licencias privadas de exploracion, emitidas por el Servicio de Exploracion, bajo la Autoridad del Emperador.
...
Esto ha llevado al Servicio de Exploración a establecer un precedente de __negocio atrografico__ mas alla de las fronteras del imperio, desde mercaderes del espacio profundo, a corporaciones Zhodani, clanes Aslan y Vargr, todos han apreciado el __valor__ de comerciar con datos actualizados de la galaxia.

***

## La Importancia del Tercer Censo

En **The Corporate Wars** el Tercer Censo representa no solo un escenario de trasfondo tematico, sino la filosofia sobre la que se construye el mapa de la Galaxía.
...
Los jugadores participan, por medio de la exploracion, en el crecimiento de los limites del juego, actualizan datos de mundos aislados y transportan información a grandes distancias.

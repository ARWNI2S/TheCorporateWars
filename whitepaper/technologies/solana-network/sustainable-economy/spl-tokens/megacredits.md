...
Players receive —by direct or indirect means— MCr as compensation for their contribution to the system. The amount of MCr assigned depends on their punctual contribution, total accumulated input, and the system's operational needs.
...
MCr acts as **institutional stake** in the system. _Polities_ with a minimum financial scope maintain MCr stakes within the Interstellar Stock Exchange; the stake amounts affect the legitimacy, operational capacity, and persistence of those _Polities_ within the Zero-Sum Economic Simulation.

{% hint style="success" %}
The community participation system encourages MCr staking to provide financial backing to specific _Polities_ —primarily _Allegiances_ and _Institutions_— controlled by AI.
{% endhint %}

This backing is not directed support to one particular _Polity_, but is distributed horizontally by the system to prevent imbalances not anticipated by gameplay, lore, or the Stabilization Algorithm.

> It also allows for regulated backing of player-run _Polities_, enabling _guilds_ and _alliances_ to create their own macroeconomic and governance structures, with capitalization limits defined by gameplay mechanics.
...
The result in-game is the intervention of local financial _Polities_ with institutional backing from the ISE, supporting large-scale operations, speculative trade route investments, or even founding _Polities_ —corporate governments, alliances, trusts, holdings, or even _Allegiances_.
...
All financial transactions conducted by a corporation within the game are translated to a $$1:1\,000\,000\ MCr$$ scale —i.e., $$0.000001\ MCr$$ equals $$1\ Cr$$ `Imperial Credit` —or the _stable_ currency defined by the relevant _Allegiance_.
